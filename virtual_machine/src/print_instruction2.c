...
/*   Updated: 2018/12/14 15:46:54 by rfibigr          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_printf("P    %d | xor %d ", processus->processus_number, arg1);
	ft_printf("%d ", arg2);
	ft_printf("r%d\n", arg3);
}
...
void	ft_print_ldi(t_processus *processus, int arg1, int arg2, int arg3)
{
	...
	, arg2, arg1 + arg2, circular(processus->action.pc + ((arg1 + arg2) % IDX_MOD)));
}
